...
const Antifon1Easter = () => (
    <>
        ...
        <p className="_-ОСНОВНОЙ_ОсновнойСТ-отст1-5">
            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">1</span> Славьте Бога, / все народы земли!
            <br />
            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">Припев</span> По хода́тайству Богородицы, о Спаситель, / спаси нас!
        </p>
        <p className="_-ОСНОВНОЙ_ОсновнойСТ-отст1-5">
            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">2</span> Славьте Бога, все народы земли, / славьте имя Его, славьте
            Его хвалой! хвалой!
            <br />
            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">Припев</span> По хода́тайству Богородицы, о Спаситель, / спаси нас!
        </p>
        <p className="_-ОСНОВНОЙ_ОсновнойСТ-отст1-5">
            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">3</span> Скажите Богу: «Как гро́зны дела Твои! / Ты могуч, враги
            заи́скивают пред Тобой.
            <br /> <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">Припев</span> По ходатайству Богородицы, Спаситель, / спаси
            нас.
        </p>
        <p className="_-ОСНОВНОЙ_ОсновнойСТ-отст1-5">
            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">4</span> Да склоня́тся пред Тобою все народы земли, / да воспоют Тебя,
            да воспоют имя Твоё, Вышний!
            <br />
            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">Припев</span> По хода́тайству Богородицы, о Спаситель, / спаси нас!
        </p>
        <p className="_-ОСНОВНОЙ_ОсновнойСТ-отст1-5">
            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">Слава, и ныне</span> По хода́тайству Богородицы, о Спаситель, / спаси
            нас!
        </p>
    </>
);
