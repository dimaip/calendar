...
const Antifon2Easter = () => (
    <>
        ...
        <p className="_-ОСНОВНОЙ_ОсновнойСТ-отст1-5">
            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">1</span> Боже, смилуйся к нам / и благослови нас!
            <br />
            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">Припев</span> Воскресший из мёртвых, Сын Божий, / спаси нас, поющих
            Тебе: / аллилуия!
        </p>
        <p className="_-ОСНОВНОЙ_ОсновнойСТ-отст1-5">
            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">2</span> Боже, смилуйся к нам и благослови нас, / просияй на нас лицом
            Твоим!
            <br />
            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">Припев</span> Воскресший из мёртвых, Сын Божий, / спаси нас, поющих
            Тебе: / аллилуия!
        ...
        <p className="_-ОСНОВНОЙ_ОсновнойСТ-отст1-5">
            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">3</span> Да позна́ем мы на земле путь Твой, / во всех народах ─
            спасение Твоё.
            <br /> Припев: Воскресший из мёртвых, Сын Божий, / спаси нас, поющих Тебе: / аллилуия!
        </p>
        <p className="_-ОСНОВНОЙ_ОсновнойСТ-отст1-5">
            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">4</span> Да восхвалят народы, Боже, Тебя, / да восхвалят Тебя народы
            все!
            <br />
            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">Припев</span> Воскресший из мёртвых, Сын Божий, / спаси нас, поющих
            Тебе: / аллилуия!
