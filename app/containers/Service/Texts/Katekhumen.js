        ...
        <>
            ...
            {!isBrightWeek && (
                <>
                    ...
                    <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                        ...
                        <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                            {' '}
                            О мире свыше и спасении наших душ Господу по­мо­лимся.
                        </span>
                    </p>
                    <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                        <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                    ...
                    <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                        ...
                        <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                            {' '}
                            и обо всём на­ро­де и властя´х её Господу помо­лимся.
                        </span>
                    </p>
                    <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                ...
                <>
                    <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                        ...
                        <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                            ...
                            че­ловеческого пославший Твоего единородного Сына и Бога, Гос­пода нашего Иисуса Христа, —
                            воззри на рабов Тво­их огла­ша­емых, склони`
                        </span>
                ...
                <>
                    <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-11">
                        ...
                        <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                            ...
                            оглашенныя, приклоньшыя своя выя пред Тобою и даждь им легкий ярем, сотвори их уды честны
                            святыя Твоея Церкве и сподоби их бани пакибытия, оставления грехов и одежди нетления, в
                            познание Тебе, истиннаго Бога нашего.
                        </span>
                    </p>
                    <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                        <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                            {' '}
                            Да и тии с нами славят пречестное и великолепое имя Твое, Отца, и Сына, и Святаго Духа, ныне
                            и присно, и во веки веков.
                        </span>
                    </p>
                </>
            ...
            <p className="_-ОСНОВНОЙ_Основной-отст5">
                ...
                <Tooltip>
                    <>
                        <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">
                            Если присутствуют просвещаемые, то здесь могут быть до­бавлены специальные Ектения и Молитва
                            о просвещаемых, сохранившиеся в Литургии преждеосвящённых даров (см.: ПБ. Кн.&nbsp;3.
                            С.&nbsp;95–96).
                        </span>
                    </>
                </Tooltip>
                ...
                <Tooltip>
                    <>
                        <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ"> Или: </span>
                        <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                            Пусть никто из оглашаемых, никто из тех, чья вера не­твер­да, никто из кающихся, никто из
                            нечистых
                        </span>
