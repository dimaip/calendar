    ...
    <>
                    ...
                    <>
                        ...
                        <p className="_-ОСНОВНОЙ_ОсновнойСТ-отст1-5">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                В гробнице — телом <br /> и в аду — душой как Бог, <br />в раю — с раз­бой­ником <br />{' '}
                                и на престоле — со Отцом и Духом <br />
                        ...
                        {lang === 'default' && (
                            <>
                                ...
                                <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                                    ...
                                    <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                        {' '}
                                        Дух Истины, о Ты, везде пребывающий и всё наполняющий, Со­кро­вищ­ница благ и
                                        жизни Податель, при­ди` и вселись в
                                    </span>
                                    <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ"> </span>
                                    <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                ...
                {isBrightWeek && (
                    <>
                        ...
                        <p className="_-ОСНОВНОЙ_ОсновнойСТ-отст1-5">
                            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">П</span> Тропарь Пасхи: Христос воскрес из мёртвых, /
                            Смертию смерть поправ // и тем, кто во гробах, Жизнь даровав. (трижды – здесь и по одному
                            разу после каждого стиха)
                        </p>
                        <p className="_-ОСНОВНОЙ_ОсновнойСТ-отст1-5">
                            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">1</span> Да воccтанет Бог, и pаc­точа́тcя вpаги Его, и
                            да бегут от лица Его ненавидящие Его;
                        </p>
                        <p className="_-ОСНОВНОЙ_ОсновнойСТ-отст1-5">
                            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">2</span> как иcчезает дым, да иcчезнут они, как тает
                            воcк от лица огня,
                        </p>
                        <p className="_-ОСНОВНОЙ_ОсновнойСТ-отст1-5">
                    ...
                    <>
                        ...
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_Чёрн-ПЕТИТ-в-осн">
                                великом господине и отце нашем святейшем
                            </span>
                            <span className="_-ВЫДЕЛЕНИЯ_Красн-ПЕТИТ-в-осн">]</span>
                        ...
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Всесвяту`ю, непоро́чную, преблагослове́н­ную, славную нашу Вла­дычицу Богородицу и
                                Веч­ноде́
                            </span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                ву Ма­рию со всеми святыми помяну`в, са­ми`х се­бя, и друг друга, и всю нашу жизнь
                                Хри­сту{' '}
                            </span>
                ...
                <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-7">
                    ...
                    <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">
                        ...
                        <Tooltip>
                            ...
                            ектениёй могут быть добавлены и соответствующие особые молитвы после дьяконского возгласа
                            "Господу помолимся!"
                        </Tooltip>
                    </span>
                    <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">.</span>
                ...
                {!isBrightWeek && (
                    <>
                        ...
                        <p className="_-ПЕТИТ_Петит-отст1-5">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Милости Божьей, Царства Небесного и прощения грехов их у Христа, бессмертного Царя и
                                Бога нашего, испросим.
                            </span>
                        </p>
                        ...
                        <p className="_-ПЕТИТ_Петит-отст1-5">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_Красн-ПЕТИТ-в-осн"> (имена) </span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                в месте светлом, в месте отрадном, в месте покойном, откуда уда­ле­ны` страдание, скорбь
                                и стена́ние. Всякое согрешение, соделанное ими словом, или делом, или в мыслях, как
                                благой и человеколюби`вый Бог прости`, ибо нет человека, который жил бы и не согрешил,
                                ведь один только Ты без греха, праведность Твоя — праведность вечная, и Твоё слово —
                                истина! —
                            </span>
                        </p>
                        <p className="_-ПЕТИТ_Петит-отст1-5 ParaOverride-15">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Ибо Ты` воскресение, и жизнь, и покой усопших чад{' '}
                            </span>
                            <span className="_-ВЫДЕЛЕНИЯ_Красн-ПЕТИТ-в-осн">(или: </span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">рабов</span>
                            <span className="_-ВЫДЕЛЕНИЯ_Красн-ПЕТИТ-в-осн">)</span>
