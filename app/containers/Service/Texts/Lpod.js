        ...
        <div>
            <div id="_idContainer004" className="_idGenObjectStyleOverride-1">
                ...
                <p className="_-ПЕТИТ_КРАСН-петит-отст1-5">
                    <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ"> [И далее Малая ектения, см. </span>
                    <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ CharOverride-3">с. 25</span>
                    <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">.]</span>
                </p>
                <p className="_-ОСНОВНОЙ_Имя-части-отст5">
                    <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">
                ...
                <p className="_-ПЕТИТ_КРАСН-петит-отст1-5">
                    ...
                    <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ CharOverride-3">см. с. 25</span>
                    <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">.]</span>
                </p>
                <p className="_-ОСНОВНОЙ_Имя-части-отст5">
                    <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">
                ...
                <p className="_-ОСНОВНОЙ_КРАСН-отст1-5">
                    <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">
                        {' '}
                        И другой, если праздник святого или храма – см. в прил. к кн. 2 настоящего издания.
                    </span>
                </p>
                <p className="_-ОСНОВНОЙ_КРАСН-отст1-5">
                    <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">
                    ...
                    <div id="footnote-005" className="_idFootnote">
                        <p className="_-СНОСКА_Сноска-КРАСНАЯ">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">
                                ...
                                Златоуста или св. Василия Великого (см.{' '}
                            </span>
                            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ CharOverride-3">с. 31–34</span>
                            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">).</span>
                        </p>
                    </div>
