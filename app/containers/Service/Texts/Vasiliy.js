            ...
            <div id="_idContainer003" className="_idGenObjectStyleOverride-1">
                ...
                {lang === 'ЦСЯ' && (
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Царю Небесный, Утешителю, Душе истины, Иже везде сый и вся исполняяй, Сокровище благих и
                                жизни Подателю, прииди и вселися в ны, и очисти ны от всякия скверны, и спаси, Блаже,
                                души наша.
                            </span>
                        </p>
                    </>
                    ...
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-4">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                ...
                                человеколюбие неизреченно. Сам, Владыко, по благоутробию Твоему, призри на ны и на
                                святый храм сей, и сотвори с нами и молящимися с нами, богатыя милости Твоя и щедроты
                                Твоя.
                            </span>
                        </p>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-5">
                    ...
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                ...
                                сохрани, освяти лю­бя­щих красоту
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                дома Твоего; Ты в ответ прославь их Твоей бо­же­ственной си­лой и не оставь нас,
                                на­дею­щих­ся на Тебя, –
                            </span>
                        </p>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                    ...
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                ...
                                сохрани, освяти любящия благолепие дому Твоего. Ты тех воспрослави Божественною Твоею
                                силою и не остави нас, уповающих на Тя.
                            </span>
                        </p>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Яко Твоя держава и Твое есть Царство и сила, и слава, Отца, и Сына, и Святаго Духа, ныне
                ...
                {lang === 'default' && (
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-5">
                            ...
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                л и даже двоим и троим, согласно собравшимся во имя Твоё, просимое подавать обещал, – Ты
                                же и ныне прошения слуг Твоих на пользу исполни: подай нам в нынешнем веке познание
                                Твоей Истины, а в будущем Жизнь вечную дару
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                ...
                {lang === 'ЦСЯ' && (
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-5">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Иже общия сия и согласныя даровавый нам молитвы, иже и двема или трем согласующимся о
                                имени Твоем прошения подати обещавый, Сам и ныне раб Твоих прошения к полезному исполни,
                                подая нам и в настоящем веце познание Твоея истины, и в будущем живот вечный даруя.
                            </span>
                        </p>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-5">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                Яко благ и человеколюбец Бог еси, и Тебе славу возсылаем, Отцу, и Сыну, и Святому Духу,
                ...
                {lang === 'default' && (
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Владыка, Господи Боже наш, Ты установил на Небесах чины
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                и воинства ангелов и архангелов для служения Твоей Славе, – соделай же, чтобы с нашим
                                входом вошли святые ангелы, вместе с нами служа
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                    ...
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                ...
                                служение Твоея славы, сотвори со входом нашим входу святых Ангелов быти, сослужащих нам,
                ...
                {lang === 'ЦСЯ' && (
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Приидите, поклонимся и припадем ко Христу. / Спаси ны, Сыне Божий, / Воскресый из
                ...
                {lang === 'default' && (
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-5">
                            ...
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                л ему во спасение покаяние. Ты удостоил нас, убогих и недостойных слуг Твоих, и в этот
                                час стать пред лицом славы Твоего святого жертвенника и должное поклонение и славословие
                                Тебе приносить, – Ты
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                        ...
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                ибо Ты свят, Боже наш, и мы воссылаем славу Тебе, Отцу и Сыну и Святому Духу, ныне и
                                всегда
                            </span>
                        </p>
                    </>
                ...
                {lang === 'ЦСЯ' && (
                    <>
                        ...
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ"> Слава, и ныне. </span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                Святый Безсмертный, помилуй нас. Святый Боже, / Святый Крепкий, / Святый Безсмертный,
                                помилуй нас.
                            </span>
                        </p>
                    </>
                    ...
                    <>
                        ...
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-11">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_Чёрн-ПЕТИТ-в-осн">
                                вме­сте со безначальным Твоим Отцом и все­святым и благим <br />и животворящим Твоим
                                Ду­хом,
                            </span>
                            <span className="_-ВЫДЕЛЕНИЯ_Красн-ПЕТИТ-в-осн">]</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ"> ныне и все­гда и во веки веков.</span>
                    ...
                    <>
                        ...
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-11">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                ...
                                безначальным Твоим Отцем, и пресвятым и благим и животворящим Твоим Духом, ныне и
                                присно, и во веки веков.
                            </span>
                        </p>
                    </>
                ...
                {lang === 'default' && (
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-11">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Господи Боже наш, прими это усердное моление от служителей Твоих, и помилуй нас, по
                                мно­жеству Твоей милости, и яви
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                ...
                {lang === 'ЦСЯ' && (
                    <>
                        ...
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-11">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Яко милостив и человеколюбец Бог еси, и Тебе славу возсылаем, Отцу, и Сыну, и Святому
                ...
                {lang === 'default' && (
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-11">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Господи Боже наш, живущий на Небесах и взи­раю­щий на всё создание Своё, воз­зри
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">[</span>Христово
                            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">]</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                , соделай их до­стойными членами Твоей святой Церкви и удостой их купели возрождения,
                                прощения грехов и одежды нетления, для познания Тебя, нашего истинного Бога, –
                            </span>
                        </p>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                ...
                {lang === 'ЦСЯ' && (
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-11">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Господи Боже наш, иже на небесех живый и призираяй на вся дела Твоя, призри на рабы Твоя
                                оглашенныя, приклоньшыя своя выя пред Тобою и даждь им легкий ярем, сотвори их уды
                                честны святыя Твоея Церкве и сподоби их бани пакибытия, оставления грехов и одежди
                                нетления, в познание Тебе, истиннаго Бога нашего.
                            </span>
                        </p>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Да и тии с нами славят пречестное и великолепое имя Твое, Отца, и Сына, и Святаго Духа,
                                ныне и присно, и во веки веков.
                            </span>
                        </p>
                    </>
                ...
                {lang === 'default' && (
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            ...
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                ин­ство спасения, Ты удостоил нас, убогих и недостойных чад Своих, стать служителями
                                Твоего святого жертвенника, – Ты же и укрепи нас силой Твоего Святого Духа для этого
                                служения, дабы, не­осужде
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                нно став пред лицом Твоей святой Славы, мы приносили Тебе жертву хвалы, ведь совершаешь
                                Ты всё во всех. И да будет, Господи, наша жертва за грехи наши и совершённые по
                                неведению Твоим народом приятной и благоугодной пред лицом Твоим. –
                            </span>
                        </p>
                        <p className="_-ОСНОВНОЙ_КРАСН-отст1-5">
                ...
                {lang === 'ЦСЯ' && (
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Ты, Господи, показал еси нам великое сие спасения таинство. Ты сподобил еси нас,
                                смиренных и недостойных раб Твоих, быти служителем святаго Твоего жертвенника. Ты удовли
                                нас, силою святаго Твоего Духа, в службу сию, да неосужденно ставше пред святою славою
                                Твоею, принесем Ти жертву хваления. Ты бо еси действуяй вся во всех. Даждь, Господи, и о
                                наших гресех, и о людских неведениих, приятней быти жертве нашей, и благоприятней пред
                                Тобою.
                            </span>
                        </p>
                        <p className="_-ОСНОВНОЙ_КРАСН-отст1-5">
                ...
                {lang === 'default' && (
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Боже, Ты посетил на­шу малость милостью и состраданием и поставил нас, убогих, и
                                грешных, и недо­стойных чад Своих, пред лицом Твоей святой Славы для слу­жения святому
                                жер­твеннику Твоему, – Ты же и укрепи нас силой Твоего Святого Духа для этого служения и
                                дару
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                й нам слово, чтобы открыть уста наши и при­зывать благодать Твоего Святого Духа на
                                при­носи
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                ...
                {lang === 'ЦСЯ' && (
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Боже, посетивый в милости и щедротах смирение наше, поставивый нас смиренных и грешных и
                                недостойных раб Твоих пред святою славою Твоею, служити святому жертвеннику Твоему. Ты
                                укрепи нас силою Святаго Твоего Духа в службу сию, и даждь нам слово во отверзение уст
                                наших, во еже призывати благодать Святаго Твоего Духа на хотящия предложитися Дары.
                            </span>
                        </p>
                        <p className="_-ОСНОВНОЙ_КРАСН-отст1-5">
                            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ"> </span>
                        ...
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Яко да под державою Твоею всегда храними, Тебе славу возсылаем, Отцу, и Сыну, и Святому
                                Духу, ныне и присно, и во веки веков.
                            </span>
                        </p>
                    </>
                ...
                {lang === 'default' && (
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            ...
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                хотями и на­слаж­де­ниями не достоин приступать и прибли­жать­ся к Тебе или слу­жить
                                Тебе, Царю Славы, ибо слу­жение Тебе – велико
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                ...
                                Пер­во­свя­щенником нашим, при­ношение этого общего слу­жения и бескровной жертвы
                                пере­да
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                        ...
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                и на меня, грешного и негодного служителя Твоего
                            </span>
                            <Tooltip>
                                <>
                                    <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">
                                        {' '}
                                        В церковнославянском тексте далее вставка:{' '}
                                    </span>
                                    <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                        и очисти мою душу и сердце от сове­сти нечистой.
                                    </span>
                                </>
                            </Tooltip>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                , и силой Твоего Свя­того Духа укрепи меня, облечённого благодатью священства, для
                                предстояния перед Твоим свя­тым престолом и принесения в жертву Твоего свя­того и
                                непорочного тела и драгоценной кро
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                        ...
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-11">
                            ...
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                , к Тебе приступаю и прошу Тебя: не отврати лица Твоего от меня и не извергни меня из
                                числа сыно
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                        ...
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-11">
                            ...
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                мый, при­ни­ма­ющий и раздаваемый, Христе Боже наш, и мы воссы­ла­ем славу Те­бе, вместе
                                со безначальным Твоим Отцом и все­святым и благим и живо­творящим Твоим Ду­хом, ныне и
                                всегда и во ве­ки веков.
                            </span>
                        </p>
                    </>
                )}
                    ...
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                ...
                                приближитися, или служити Тебе, Царю Славы: еже бо служити Тебе, велико и страшно и
                                самем Небесным Силам. Но обаче неизреченнаго ради и безмернаго Твоего человеколюбия,
                                непреложно и неизменно был еси Человек, и Архиерей нам был еси: и служебныя сея и
                                безкровныя жертвы священнодействие предал еси нам, яко Владыка всех. Ты бо един, Господи
                                Боже наш, владычествуеши небесными и земными, иже на престоле Херувимсте носимый, иже
                                Серафимов Господь, и Царь Израилев, иже Един свят, и во святых почиваяй.
                            </span>
                        </p>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                Тя убо молю, Единаго благаго и благопослушливаго: призри на мя, грешнаго и непотребнаго
                                раба Твоего, и очисти мою душу и сердце от совести лукавыя, и удовли мя, силою святаго
                                Твоего Духа, облечена благодатию священства, предстати святей Твоей сей трапезе, и
                                священнодействовати Святое и Пречистое Твое Тело и Честную Кровь.
                            </span>
                        </p>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-11">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                К Тебе бо прихожду приклонь мою выю, и молю Ти ся, да не отвратиши лица Твоего от мене,
                                ниже отринеши мене от отрок Твоих, но сподоби принесенным Тебе быти, мною грешным и
                                недостойным рабом Твоим, даром сим.
                            </span>
                        </p>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-11">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Ты бо еси приносяй и приносимый, и приемляй и раздаваемый, Христе Боже наш, и Тебе славу
                                возсылаем, со безначальным Твоим Отцем, и Пресвятым, и Благим, и Животворящим Твоим
                ...
                {lang === 'default' && (
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-5">
                            ...
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                л откровение небесных таинств! Ты поставил нас на это служение силой Твоего Святого Духа
                                – так удостой нас, Господи, стать служителями Нового Завета Твоего и совершителями Твоих
                                святых таинств. По множеству Твоей милости прими нас, приближающихся к Твоему святому
                                жертвеннику, дабы мы были достойны приносить Тебе эту духовную и бескровную жертву за
                                грехи наши и совершённые по неведению Твоим народом. Приня
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                в же её на Свой святой, и пренебесный, и умопостига
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                        ...
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-5">
                            ...
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                нял от Твоих святых апостолов это истинное служение, так, по благости Твоей, Господи,
                                прими и из рук нас, грешных, эти предлежащие
                            </span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ"> дары</span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                , дабы и мы, удо­стоившись безупречно служить Твоему святому жерт­вен­ни­ку, обрели
                                награду верных и разумных домо­прави
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                телей в Страшный День Твоего справедливого воздаяния, –
                            </span>
                        </p>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-11">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                    ...
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-5">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                ...
                                даровавый нам Небесных Таин откровение. Ты бо еси положивый нас в службу сию, силою Духа
                                Твоего Святаго. Благоволи убо, Господи, быти нам служителем новаго Твоего Завета, слугам
                                святых Твоих Таинств. Приими нас, приближающихся святому Твоему жертвеннику, по
                                множеству милости Твоея, да будем достойни приносити Тебе словесную сию и безкровную
                                жертву о наших согрешениих и о людских невежествиих: юже прием во святый и пренебесный,
                                и мысленный Твой жертвенник, в воню благоухания, возниспосли нам благодать Святаго
                                Твоего Духа.{' '}
                            </span>
                        </p>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-5">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Призри на ны, Боже, и виждь на службу сию нашу, и приими ю, якоже приял еси Авелевы
                                дары, Ноевы жертвы, Авраамова всеплодия, Моисеова и Ааронова священства, Самуилова
                                мирная. Якоже приял еси от святых Твоих Апостол истинную сию службу, сице и от рук нас,
                                грешных, приими Дары сия в благости Твоей, Господи, яко да сподобльшеся служити без
                                порока святому Твоему жертвеннику, обрящем мзду верных и мудрых строителей в день
                                страшный воздаяния Твоего праведнаго
                            </span>
                        </p>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-11">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                ...
                {lang === 'default' && (
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">(Или: </span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                Будем приветст­во­вать друг друга целованием святым! –{' '}
                            </span>
                ...
                {lang === 'default' && (
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст5">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Станем строго, станем благоговейно! Будем со вни­манием святое возношение в мире
                                при­но­сить:
                            </span>
                        </p>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                        ...
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Благодать Господа нашего Иисуса Хри­ста, и любовь Бога и Отца, и общение Святого Ду­ха
                ...
                {lang === 'ЦСЯ' && (
                    <>
                        ...
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Достойно и праведно есть покланятися Отцу и Сыну, и Святому Духу, Троице единосущней и
                                нераздельней.
                            </span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">.</span>
                        </p>
                ...
                {lang === 'default' && (
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст5">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                Сущий, Владыка, Господь, Бог-Отец, Вседержитель, Которому подобает поклонение! Поистине
                            ...
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                зно великолепию святости Твоей – восхвалять Те­бя
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                , воспевать Тебя, благословлять Тебя, покло­няться Тебе, благодарить Тебя и прославлять
                                Тебя, одного воистину существующего Бо­га, и с сокрушённым сердцем и сми­ре
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                        ...
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-11">
                            ...
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                чь могущество Твоё, возвестить все хвалы Тебе или пове
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                            ...
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                , Владыка всего, Господь неба и земли и всего видимого и невидимого творения,
                                восседающий на престоле Славы и прозрева
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">ющий бездны, безначальный, невидимый, непостижи</span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                мый, необъятный, неизменный, Отец Господа нашего Иисуса Христа, великого Бога и
                                Спасителя, Надежды нашей.
                            </span>
                        </p>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-11">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Он же есть образ Твоей благости, верный отпечаток, в Себе являющий Тебя, Отца; Он есть
                                живое Сло­во, истинный Бог, превечная Премудрость, Жизнь, Освящение, Сила, Свет
                                истинный.
                            </span>
                        </p>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-11">
                            ...
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                ток вечных благ, животворящая сила, источник освящения.
                            </span>
                        </p>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-11">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                            ...
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                ющее славословие все духовные и разумные создания, ибо они все – служители Твои: Тебя
                                восхваляют ангелы, архангелы, престолы, господства, начала, власти, силы и многоокие
                                херувимы, вокруг Тебя предстоят серафимы – шесть крыл у одних и шесть крыл у других, – и
                                двумя они покрывают лица свои, а двумя – ноги, и двумя летают, в не­пре­станном
                                славо­словии взывая друг ко другу неумолка
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                ...
                {lang === 'ЦСЯ' && (
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст5">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Сый Владыко, Господи Боже Отче Вседержителю покланяемый! Достойно яко воистинну, и
                                праведно, и лепо великолепию святыни Твоея, Тебе хвалити, Тебе пети, Тебе благословити,
                                Тебе кланятися, Тебе благодарити, Тебе славити единаго воистинну сущаго Бога, и Тебе
                                приносити сердцем сокрушенным и духом смирения словесную сию службу нашу, яко Ты еси
                                даровавый нам познание Твоея истины.
                            </span>
                        </p>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-11">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                И кто доволен возглаголати силы Твоя, слышаны сотворити вся хвалы Твоя, или поведати вся
                                чудеса Твоя во всяко время. Владыко всех, Господи небесе и земли, и всея твари, видимыя
                                же и невидимыя, седяй на престоле славы и призираяй бездны, безначальне, невидиме,
                                непостижиме, неописанне, неизменне, Отче Господа нашего Иисуса Христа, великаго Бога и
                                Спасителя, упования нашего, иже есть образ Твоея благости:
                            </span>
                        </p>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-11">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                печать равнообразная, в себе показуя Тя, Отца, Слово живое, Бог истинный, превечная
                                Премудрость, живот, освящение, сила, свет истинный,{' '}
                            </span>
                        </p>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-11">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                имже Дух Святый явися; Дух истины, сыноположения дарование, обручение будущаго наследия,
                                начаток вечных благ, животворящая сила, источник освящения, от негоже вся тварь
                                словесная же и умная укрепляема Тебе служит и Тебе присносущное возсылает славословие,
                        ...
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-11">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Тебе бо хвалят Ангели, Архангели, Престоли, Господьствия, Начала, Власти, Силы и
                                многоочитии Херувими. Тебе предстоят окрест Серафими, шесть крил единому, и шесть крил
                                единому; и двема убо покрывают лица своя, двема же ноги, и двема летающе, взывают един
                                ко другому, непрестанными усты, немолчными славословеньми.
                            </span>
                        </p>
                    </>
                )}
                ...
                {lang === 'default' && (
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                победную песнь воспевая, восклицая, возглашая и говоря{' '}
                            </span>
                        ...
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                С этими блаженными силами, человеколюбивый Владыка, и мы, грешные, восклицаем и говорим:
                                Ты поистине свят и всесвят, и нет меры великолепию святости Твоей; и праведен Ты во всех
                                делах Своих, ибо Ты всё навёл на нас по справедливости и истинному суду!
                            </span>
                        </p>
                    </>
                )}
                ...
                {lang === 'ЦСЯ' && (
                    <>
                        ...
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_Красн-ПЕТИТ-в-осн">(т. е. небесных воинств)</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                ; исполнь небо и земля славы Твоея; осанна в вышних, благословен Грядый во имя Господне,
                                осанна в вышних.{' '}
                            </span>
                            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">(Народ вторит.)</span>
                        </p>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                С сими блаженными силами, Владыко человеколюбче, и мы, грешнии, вопием и глаголем: свят
                                еси, яко воистинну, и пресвят, и несть меры великолепию святыни Твоея, и преподобен во
                                всех делех Твоих, яко правдою и судом истинным вся навел еси на ны:
                            </span>
                        </p>
                    </>
                )}
                ...
                {lang === 'default' && (
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст5">
                            ...
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                вшего его, и об­ма­ном змия прельщённого, и умерщвлённого собствен­ными согреше­ниями,
                                Ты изгнал его по справедливому су­ду Твоему, Боже, из ра
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                        ...
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-5">
                            ...
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                мения через Своих святых, в каждом роде благоугожда
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                вших Тебе, Ты говорил нам устами Своих слуг пророков, предвозвещая нам грядущее
                                спасение, Ты Закон дал в помощь и ангелов поставил хранителями. А когда настала полнота
                                времён, Ты говорил нам в Само
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                м Своём Сыне, чрез Которого Ты и ход веков сотворил. Он же, будучи излуче­нием Твоей
                                Славы и отпечатком Сущности{' '}
                            </span>
                            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">(или: </span>
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Твоей, всё держа могущественным словом Своим, не почитал хищением быть равным Тебе, Богу
                                и Отцу; но, будучи Богом превечным, Он явился на земле и жил с людьми и, от святой Девы
                                воплотившись, ума
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            ...
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                в человеческий облик и соделавшись подобным уничиже
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                        ...
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-5">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Поскольку через человека грех вошёл в мир и через грех{' '}
                            </span>
                            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">[</span>
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                смерть, Твой единородный Сын, сущий в недрах Твоих, Бога и Отца, родился от женщины –
                                святой Богородицы и Вечноде
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                вы Марии, – родился под Законом, чтобы в Своей пло
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                ти осудить грех, дабы умирающие в Адаме оживотво­ри
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            ...
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                доль­ского заблуждения, Он при­вёл нас к познанию Тебя, истинного Бога и От­ца,
                                приобретя
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            ...
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                збранный, царственное священство, род святой. И очистив нас во­дою и освятив Духом
                                Святым, Он вместо нас Себя отда
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">л смерти, которой принадлежали мы, про</span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                данные под власть Греха. И сойдя чрез крест во ад, чтобы Собой наполнить всё, Он расторг
                                утробу смерти. И воскре
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            ...
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                рвенцем из мёртвых, дабы иметь Ему между всеми во всём первенство. И взойдя на Небеса,
                                Он{' '}
                            </span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                воссел по правую сторону Твоего величия в вышних; Он и придёт воздать каждому по делам
                                его.
                            </span>
                        </p>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-5">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Он же в воспоминание Своего спасительного страдания оставил нам то, что мы ныне, по
                                заповеди Его, возлагаем пред Тобою. Ибо намере­ва
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                            ...
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                щую смерть, Он в ту ночь, в которую отдавал Себя за Жизнь мира, взяв хлеб в Свои святые
                                и непорочные руки и показав его Тебе, Богу и Отцу, возблагода­рив и благословив,
                                освятив, преломи
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                        ...
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-5">
                            ...
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                л его Своим святым ученикам и апостолам, сказав: «Прими
                            </span>
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                ...
                {lang === 'ЦСЯ' && (
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст5">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                создав бо человека, персть взем от земли, и образом Твоим, Боже, почет, положил еси в
                                раи сладости, безсмертие жизни и наслаждение вечных благ, в соблюдении заповедей Твоих
                                обещав ему, но преслушавша Тебе, истиннаго Бога, создавшаго его, и прелестию змиевою
                                привлекшася, умерщвлена же своими прегрешеньми, изгнал еси его праведным Твоим судом,
                                Боже, от рая в мiр сей, и отвратил еси в землю, от неяже взят бысть, устрояя ему еже от
                                пакибытия спасение, в Самем Христе Твоем.
                            </span>
                        </p>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-5">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Не бо отвратился еси создания Твоего в конец, еже сотворил еси, Блаже, ниже забыл еси
                                дела рук Твоих, но посетил еси многообразне, ради милосердия милости Твоея. Пророки
                                послал еси, сотворил еси силы святыми Твоими, в коемждо роде благоугодившими Тебе.
                                Глаголал еси нам усты раб Твоих пророков, предвозвещая нам хотящее быти спасение. Закон
                                дал еси в помощь, Ангелы поставил еси хранители. Егда же прииде исполнение времен,
                                глаголал еси нам самем Сыном Твоим, Имже и веки сотворил еси, Иже сый сияние славы Твоея
                                и начертание ипостаси Твоея, нося же вся глаголом силы Своея, не хищение непщева еже
                                быти равен Тебе, Богу и Отцу, но Бог сый превечный, на земли явися и человеком споживе.
                                И от Девы Святыя воплощся, истощи Себе, зрак раба прием, сообразен быв телу смирения
                                нашего, да нас сообразны сотворит образу славы Своея.
                            </span>
                        </p>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-5">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Понеже бо человеком грех вниде в мiр и грехом смерть, благоволи Единородный Твой Сын,
                                сый в недрех Тебе, Бога и Отца, быв от жены, Святыя Богородицы и Приснодевы Марии, быв
                                под законом, осудити грех во плоти Своей, да во Адаме умирающе, оживотворятся в самем
                                Христе Твоем. И пожив в мiре сем, дав повеления спасительная, отставив нас прелести
                                идольския, приведе в познание Тебе, истиннаго Бога и Отца, стяжав нас Себе, люди
                                избранны, царское священие, язык свят. И очистив водою, и освятив Духом Святым, даде
                                Себе измену смерти, в нейже держими бехом, продани под грехом, и сошед крестом во ад, да
                                исполнит Собою вся, разреши болезни смертныя. И воскрес в третий день, и путь сотворив
                                всякой плоти к воскресению из мертвых, зане не бяше мощно держиму быти тлением
                                начальнику жизни, бысть начаток умерших, перворожден из мертвых, да будет Сам вся, во
                                всех первенствуяй. И возшед на небеса, седе одесную величествия Твоего на высоких, иже и
                                приидет воздати комуждо по делом его.
                            </span>
                        </p>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-5">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Остави же нам воспоминания спасительнаго Своего страдания сия, яже предложихом по Его
                                заповедем. Хотя бо изыти на вольную и приснопамятную, и животворящую Свою смерть, в
                                нощь, в нюже предаяше Себе за живот мiра, прием хлеб на святыя Своя и пречистыя руки,
                        ...
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-5">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                даде святым Своим учеником и Апостолом, рек: приимите, ядите, сие есть Тело Мое, еже за
                                вы ломимое, во оставление грехов.
                            </span>
                        </p>
                    </>
                )}
                ...
                {lang === 'default' && (
                    <>
                        ...
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-5">
                            ...
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                л её Своим святым ученикам и апостолам, сказав: «Пейте из неё все, это кровь Моя, кровь
                                Нового Завета, за вас и за многих изливаемая ради прощения грехов.
                            </span>
                        </p>
                    </>
                )}
                ...
                {lang === 'ЦСЯ' && (
                    <>
                        ...
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-5">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                даде святым Своим учеником и Апостолом, рек: пийте от нея вси, сия есть Кровь Моя Новаго
                                завета, яже за вы и за многи изливаемая во оставление грехов.
                            </span>
                        </p>
                    </>
                )}
                ...
                {lang === 'default' && (
                    <>
                        ...
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-5">
                            ...
                            <span className="_-ДР--ГАРНИТУРЫ_УДАРЕНИЕ">`</span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                щий крест, тридневное погребение, из мёртвых воскресение, на Небеса восхождение, по
                                правую руку от Тебя, Бога и Отца, восседание и Его славное и страшное Второе Пришествие,
                            </span>
                        </p>
                    </>
                )}
                ...
                {lang === 'ЦСЯ' && (
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-5">
                            ...
                            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">П </span>
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                Сие творите в Мое воспоминание: елижды бо аще ясте Хлеб сей и Чашу сию пиете, Мою смерть
                                возвещаете, Мое воскресение исповедаете.
                            </span>
                        </p>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-5">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Поминающе убо, Владыко, и мы спасительная Его страдания, животворящий Крест, тридневное
                                погребение, еже из мертвых воскресение, еже на небеса возшествие, еже одесную Тебе, Бога
                                и Отца, седение, и славное, и страшное Его второе пришествие.
                            </span>
                        </p>
                    </>
                )}
                        ...
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-5">
                            ...
                            <Tooltip>
                                <>
                                    ...
                                    <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                        «согласно всему (этому) (по всем этим причинам) и для всего (этого)» (Е.
                                        Ло­вягин и др.).
                                    </span>
                                </>
                            </Tooltip>
                ...
                {lang === 'default' && (
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-5">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                {' '}
                                Тебя воспеваем, Тебя благословляем, Тебя бла­го­да­рим, Господи, и Тебе молимся, Боже
                                наш!
                            </span>
                            ...
                            <Tooltip>
                                <>
                                    <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">
                                        В церковнославянском тексте Служебника далее следует вставка: тропарь Третьего
                                        часа, со стихами (см. Приложения в кн. 1 серии «Православное богослужение», а
                                        также Третий час в кн. 7).
                                    </span>
                                </>
                            </Tooltip>
                        </p>
                ...
                {lang === 'ЦСЯ' && (
                    <>
                        <p className="_-ОСНОВНОЙ_Основной-отст1-5 ParaOverride-5">
                            <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">
                                Тебе поем, Тебе благословим, Тебе благодарим, Господи, и молим Ти ся, Боже наш.Тебя
                                воспеваем, Тебя благословляем, Тебя бла­го­да­рим, Господи, и Тебе молимся, Боже наш!
                            </span>
                            <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ"> (На­род вто­рит.)</span>
                            <Tooltip>
                                <>
