        ...
        <div>
            <div id="_idContainer003" className="_idGenObjectStyleOverride-1">
                    ...
                    <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">
                        ...
                        <Tooltip>
                            <>
                                <span className="_-ВЫДЕЛЕНИЯ_КРАСНЫЙ">
                                    {' '}
                                    Далее могут быть ещё добавлены особые прошения, в т. ч. по специальной просьбе
                                    верных, о болящих, по случаю различных бедствий, скорбей и нужд и т. д. Также перед
                                    Заупокойной ектениёй могут быть добавлены и соответствующие особые молитвы после
                                    дьяконского возгласа{' '}
                                </span>
                                <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ">Господу помолимся!</span>
                            </>
                        </Tooltip>
                ...
                <p className="_-ОСНОВНОЙ_Имя-части-отст5 ParaOverride-2">
                    ...
                    <Tooltip>
                        Не читается в храмовые (престольные) и двунадесятые праздники и, как правило, в воскресные дни,
                        дни Святок и всей св. Пятидесятницы.
                    </Tooltip>
                </p>
                <p className="_-ПЕТИТ_Петит-отст1-5">
                    <span className="_-ВЫДЕЛЕНИЯ_ЧЁРНЫЙ"> </span>
