...
import PassionSaturdayCanon from 'containers/Service/Texts/Matins/PassionSaturdayCanon/PassionSaturdayCanon.mdx';
...
**По отпусте утрени, согласно указанию Типикона, «целуем Честный Крест, держимый в руку настоятеля». Но если непосредственно за окончанием утрени следуют часы и Литургия, то целование Креста можно отнести к окончанию Литургии.**
...
Далее совершается Божественная Литургия.
